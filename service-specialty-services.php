<?php
/**
 * Template Name: Specialty Services Template
 *
 * Specialty Cleaning service page
...
<main class="bs-service-page overflow-hidden bg-[var(--bs-bg)] text-[var(--bs-text)]">
  ...
  <?php
    // Images
    $hero_image   = 'http://brilliant-star-cleaning.local/wp-content/uploads/2026/04/SpeclialityCleaningService.jpg-scaled.jpeg';
    $detail_image = 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?q=80&w=1200&auto=format&fit=crop';

    // Included focus areas
    $included = [
      'Specialty residential cleaning tailored to your specific situation',
      'Flexible service planning based on your household needs',
      'Custom quote built around the scope of work requested',
      'A personalized approach instead of a one-size-fits-all package',
      'Support for unique cleaning requests beyond our standard services',
      'A clear conversation about what we can do before scheduling',
    ];
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    <div class="absolute inset-0">
      <img
        ...
        alt="Specialty cleaning service in a San Diego home"
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      ...
      <div class="mt-12 grid gap-4 md:grid-cols-3">
        <div class="bs-reveal-stagger bs-hero-strip-card">
          ...
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Unique Cleaning Situations</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">Approach</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Personalized Around Your Needs</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">Next Step</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Tell Us What You Need</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        ...
        <div class="bs-reveal-right">
          ...
          <div class="mt-7 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            <p>
              Not every home cleaning need fits neatly into a standard package. That&apos;s why we offer specialty services designed around your specific circumstances and goals.
            </p>
            <p>
  ...
  <section id="included" class="relative overflow-hidden border-y border-[var(--bs-border)] bg-white py-16 lg:py-20">
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
        <div class="bs-reveal-left">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">How It Works</p>
          <h2 class="mt-4 max-w-[13ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            What to Expect with Specialty Services
          </h2>
        </div>
      ...
      <div class="bs-reveal-up overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="px-6 py-6 md:px-8" style="border-bottom:1px solid var(--bs-border); background:var(--bs-card-soft-bg)">
          ...
          <h2 class="mt-2 text-3xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)] md:text-4xl">
            We’ll talk through it and build a quote that makes sense
          </h2>
        </div>

        <div class="px-6 py-6 md:px-8 md:py-8">
          <p class="text-base leading-8 text-[var(--bs-text-soft)]">
            Get in touch and tell us about your situation. We&apos;ll let you know what we can do and put together a quote that makes sense.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="bs-reveal-up text-center">
        ...
        <p class="mx-auto mt-5 max-w-3xl text-base leading-8 text-[var(--bs-text-soft)]">
          From recurring service to move-related cleaning and post-renovation cleanup, we offer personalized service for every home.
        </p>
      </div>
      ...
      <div class="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        ...
        <a href="/services/post-construction-cleaning/" class="bs-reveal-stagger bs-related-card">
          <span class="bs-related-card__eyebrow">Post-Construction</span>
          <h3 class="mt-3 text-2xl font-semibold tracking-[-0.03em] text-[var(--bs-primary)]">
            Post-Construction Cleaning in San Diego
          </h3>
          <p class="mt-4 text-base leading-8 text-[var(--bs-text-soft)]">
            We handle the dust, debris, and residue left behind after small to mid-size renovation projects.
          </p>
        </a>
      </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div class="bs-reveal-left">
          ...
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Specialty Cleaning Services Across San Diego &amp; Nearby Neighborhoods
          </h2>
            ...
            <?php foreach ($featured_service_areas as $area) : ?>
              ...
              >
                ...
                <h3 class="mt-3 text-2xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)]">
                  Specialty Cleaning in <?php echo esc_html($area['name']); ?>
                </h3>

                <p class="mt-3 text-sm leading-7 text-[var(--bs-text-soft)]">
                  Explore specialty cleaning services available in <?php echo esc_html($area['name']); ?>, San Diego.
                </p>
      ...
      <div class="overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="grid gap-10 px-6 py-10 md:px-10 md:py-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div class="bs-reveal-left">
            ...
            <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
              Need something outside the usual cleaning packages?
            </h2>
...
<?php
  $schema = [
    ...
    '@graph' => [
      ...
      [
        '@type' => 'Service',
        '@id' => home_url('/services/specialty-services/') . '#service',
        'name' => 'Specialty Cleaning Services in San Diego',
        'description' => 'Need something unique? Brilliant Star offers specialty residential cleaning services in San Diego tailored to your specific situation.',
        'provider' => [
          '@type' => 'LocalBusiness',
          '@id' => home_url('/#business')
        ],
        ...
        'url' => home_url('/services/specialty-services/')
      ]
    ]
  ];
