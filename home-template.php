...
<main class="bs-home overflow-hidden bg-[var(--bs-bg)] text-[var(--bs-text)]">
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    <div class="absolute inset-0">
      ...
      <div class="absolute inset-y-0 left-[7%] hidden w-px bg-white/10 lg:block"></div>
      <div class="absolute inset-y-0 right-[11%] hidden w-px bg-white/8 lg:block"></div>
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      <div class="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-end">
        ...
        <div class="bs-reveal-up">
          <div class="max-w-3xl">
            <p class="inline-flex border border-[rgba(201,161,58,0.36)] bg-[rgba(255,255,255,0.08)] px-4 py-2 text-[11px] font-extrabold uppercase tracking-[0.24em] text-white/92 backdrop-blur-sm shadow-[0_10px_30px_rgba(0,0,0,0.12)]">
            ...
            <div class="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <a href="#services" class="bs-btn bs-btn-outline-white inline-flex items-center justify-center px-7 py-4 text-sm font-black uppercase tracking-[0.15em] text-white">
      ...
      <div class="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
        ...
        <div class="grid gap-5 md:grid-cols-2">
          <?php foreach ($services as $service) : ?>
            <article class="bs-reveal-stagger bs-service-card group relative overflow-hidden border border-[var(--bs-border)] bg-[linear-gradient(180deg,#ffffff_0%,#fcfbf8_100%)] p-6 shadow-[var(--bs-shadow-service)]">
              <div class="absolute inset-y-0 left-0 w-[4px] bg-[linear-gradient(180deg,var(--bs-accent)_0%,var(--bs-gold)_100%)] opacity-0 transition duration-[var(--bs-duration-card)] group-hover:opacity-100"></div>
              ...
              <a href="<?php echo esc_url($service['link']); ?>" class="bs-service-link mt-7 inline-flex items-center gap-2 text-sm font-black uppercase tracking-[0.14em] transition hover:gap-3">
      ...
      <div class="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
        ...
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          <?php foreach ($locations as $location) : ?>
            <a href="<?php echo esc_url($location['link']); ?>" class="bs-reveal-stagger bs-location-card group flex min-h-[88px] items-center justify-between border border-[var(--bs-border)] bg-[linear-gradient(180deg,#ffffff_0%,#fbfaf7_100%)] px-5 py-4 shadow-[var(--bs-shadow-location)]">
              <div>
              ...
              <span class="text-[var(--bs-accent)] transition group-hover:translate-x-1 group-hover:text-[var(--bs-gold)]">→</span>
            </a>
          <?php endforeach; ?>
        </div>
      </div>
        ...
        <?php foreach ($faqs as $faq) : ?>
          <details class="bs-reveal-stagger bs-faq-item group overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-faq)]">
            <summary class="flex cursor-pointer list-none items-center justify-between gap-5 px-6 py-5 text-left">
              ...
              <span class="shrink-0 text-2xl font-light text-[var(--bs-accent)] transition group-open:rotate-45 group-open:text-[var(--bs-gold)]">+</span>
            </summary>
  ...
  <!-- FINAL CTA -->
  <section class="relative overflow-hidden border-t border-[var(--bs-border)] bg-[linear-gradient(180deg,#faf9f5_0%,#f1f3ef_100%)] py-20 lg:py-24">
...
<style>
  ...
  :root {
    ...
    --bs-shadow-hero-form:       0 40px 90px rgba(0, 0, 0, 0.24);
    ...
    --bs-shadow-location:        0 12px 30px rgba(24, 54, 74, 0.05);
    --bs-shadow-faq:             0 12px 36px rgba(24, 54, 74, 0.05);

    --bs-shadow-hover-rise:      0 18px 44px rgba(24, 54, 74, 0.10);
    --bs-shadow-hover-service:   0 28px 60px rgba(24, 54, 74, 0.10);
    --bs-shadow-hover-location:  0 20px 44px rgba(24, 54, 74, 0.08);
    --bs-shadow-hover-faq:       0 18px 42px rgba(24, 54, 74, 0.07);
    --bs-shadow-hover-faq-open:  0 20px 46px rgba(24, 54, 74, 0.08);
    ...
    --bs-shadow-btn-gold:            0 18px 38px rgba(201, 161, 58, 0.22);
    --bs-shadow-btn-gold-hover:      0 22px 44px rgba(201, 161, 58, 0.30);
    --bs-shadow-btn-white-hover:     0 18px 40px rgba(24, 54, 74, 0.16);

    --bs-input-focus-border: rgba(154, 179, 199, 0.55);
    --bs-input-focus-ring:   rgba(154, 179, 199, 0.14);

    --bs-border-hover-service:   rgba(154, 179, 199, 0.30);
    --bs-border-hover-location:  rgba(154, 179, 199, 0.34);
    --bs-border-hover-faq-open:  rgba(154, 179, 199, 0.26);

    --bs-hero-overlay: linear-gradient(
      92deg,
      rgba(20, 39, 51, 0.76) 0%,
      rgba(20, 39, 51, 0.64) 38%,
      rgba(20, 39, 51, 0.34) 70%,
      rgba(20, 39, 51, 0.14) 100%
    );

    --bs-hero-glow-tl: radial-gradient(
      circle at top left,
      rgba(154, 179, 199, 0.18),
      transparent 28%
    );

    --bs-hero-glow-br: radial-gradient(
      circle at bottom right,
      rgba(201, 161, 58, 0.12),
      transparent 24%
    );

    --bs-hero-line-h: linear-gradient(
      90deg,
      transparent,
    ...
    --bs-hero-fade-b: linear-gradient(
      180deg,
      transparent,
      rgba(20, 39, 51, 0.24)
    );

    --bs-cta-glow-tl: radial-gradient(
      circle at top left,
      rgba(154, 179, 199, 0.18),
      transparent 28%
    );

    --bs-cta-glow-br: radial-gradient(
      circle at bottom right,
      rgba(201, 161, 58, 0.14),
      transparent 26%
    );

    --bs-services-glow: radial-gradient(
      circle at top right,
      rgba(154, 179, 199, 0.10),
      transparent 22%
    );

    --bs-img-fade-b: linear-gradient(
      180deg,
      transparent,
      rgba(24, 54, 74, 0.42)
    );

    --bs-cta-soft-glow-tl: radial-gradient(
      circle at top left,
      rgba(154, 179, 199, 0.12),
      transparent 28%
    );

    --bs-cta-soft-glow-br: radial-gradient(
      circle at bottom right,
      rgba(201, 161, 58, 0.10),
      transparent 24%
    );
  ...
  .bs-trust-marquee-item {
    ...
    border-right: 1px solid rgba(24, 54, 74, 0.08);
  ...
  .bs-service-mark {
    ...
    height: 10px;
    border-radius: 999px;
    background: linear-gradient(90deg, var(--bs-accent) 0%, var(--bs-gold) 100%);
  }
  ...
  .bs-btn-outline-white {
    ...
    border-color: rgba(154,179,199,0.34);
    color: white;
    backdrop-filter: blur(8px);
    clip-path: polygon(0 0, calc(100% - var(--bs-clip-btn)) 0, 100% var(--bs-clip-btn), 100% 100%, var(--bs-clip-btn) 100%, 0 calc(100% - var(--bs-clip-btn)));
  }
  ...
  .bs-btn-outline-white:hover {
    background: rgba(154,179,199,0.18);
    border-color: rgba(154,179,199,0.48);
    color: white;
  ...
  .bs-faq-item:hover {
    ...
    box-shadow: var(--bs-shadow-hover-faq);
  }

  .bs-faq-item[open] {
    border-color: var(--bs-border-hover-faq-open);
    box-shadow: var(--bs-shadow-hover-faq-open);
  }
