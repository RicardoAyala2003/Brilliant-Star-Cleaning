<?php
/**
 * Template Name: University Heights Location Template
 *
 * Location page for University Heights
...
<main class="bs-service-page overflow-hidden bg-[var(--bs-bg)] text-[var(--bs-text)]">
  ...
  <?php
    // Images
    $hero_image   = 'https://images.unsplash.com/photo-1464146072230-91cabc968266?q=80&w=1600&auto=format&fit=crop';
    $detail_image = 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?q=80&w=1200&auto=format&fit=crop';

    // Services list
    $services = [
      [
        'title' => 'Regular / Residential Cleaning',
        'copy'  => 'Keep your University Heights home consistently clean with recurring service tailored to your household and schedule.',
        'url'   => '/services/residential-cleaning/',
      ],
      [
        'title' => 'Deep Cleaning',
        'copy'  => 'A more detailed clean that goes beyond the surface and covers the areas regular cleaning doesn’t.',
        'url'   => '/services/deep-cleaning/',
      ],
      [
        'title' => 'Move-Out Cleaning',
        'copy'  => 'Leave your University Heights home spotless and move-out ready with a thorough, detail-focused cleaning.',
        'url'   => '/services/move-out-cleaning/',
      ],
      [
        'title' => 'Move-In Cleaning',
        'copy'  => 'Start fresh in your new home with a detailed cleaning before you unpack and settle in.',
        'url'   => '/services/move-in-cleaning/',
      ],
      [
        'title' => 'Post-Construction Clean-Up',
        'copy'  => 'We remove dust, debris, and renovation residue so your home feels complete and livable again.',
        'url'   => '/services/post-construction-cleaning/',
      ],
      [
        'title' => 'Specialty Services',
        'copy'  => 'Need something unique? We offer flexible specialty cleaning services based on your specific situation.',
        'url'   => '/services/specialty-services/',
      ],
    ];
    ...
    $nearby_locations = [
      ...
      ['name' => 'Ocean Beach', 'url' => '/locations/ocean-beach/'],
    ...
    $faq_items = [
      [
        'q' => 'Do you offer house cleaning services in University Heights?',
        'a' => 'Yes. Brilliant Star Cleaning Services proudly serves households in University Heights with personalized residential cleaning, deep cleaning, move-in and move-out services, post-construction clean-up, and specialty cleaning.'
      ],
      [
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    <div class="absolute inset-0">
      <img
        ...
        alt="House cleaning services in University Heights San Diego"
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      <div class="max-w-4xl">
        ...
        <h1 class="bs-reveal-up mt-6 max-w-[13ch] text-4xl font-semibold leading-[0.95] tracking-[-0.05em] text-white md:text-6xl xl:text-7xl">
          Professional House Cleaning Services in University Heights, San Diego
        </h1>

        <p class="bs-reveal-up mt-6 max-w-2xl text-base leading-8 text-white/82 md:text-lg">
          Looking for a trusted, experienced home cleaning service in University Heights? Brilliant Star Cleaning Services has been serving San Diego households — including University Heights — for over 15 years. We’re local, licensed, insured, and genuinely committed to leaving every home we clean in exceptional condition.
        </p>

        <div class="bs-reveal-up mt-8 flex flex-col gap-4 sm:flex-row">
          <a href="#services" class="bs-btn bs-btn-primary inline-flex items-center justify-center px-7 py-4 text-sm font-black uppercase tracking-[0.15em] text-white">
            Explore Services
          </a>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div class="bs-reveal-left">
          <div class="relative overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
            <img
              ...
              alt="Residential cleaning in University Heights San Diego"
        ...
        <div class="bs-reveal-right">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Trusted House Cleaning in University Heights</p>
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Personalized cleaning for University Heights households
          </h2>

          <div class="mt-7 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            <p>
              Whether you need a recurring residential cleaning, a thorough deep clean, a move-out service, or anything in between — we’ll personalize our approach to your home’s needs and give you a clear, honest quote before we begin.
            </p>
            <p>
              We work with University Heights homeowners, renters, families, and busy households that want dependable cleaning backed by real experience, detail-focused work, and professional standards.
            </p>
            <p>
              Our goal is simple: make your home feel clean, comfortable, and cared for — without adding more to your plate.
            </p>
          </div>
  ...
  <section id="services" class="relative overflow-hidden border-y border-[var(--bs-border)] bg-white py-16 lg:py-20">
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
        <div class="bs-reveal-left">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Services in University Heights</p>
          <h2 class="mt-4 max-w-[13ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Services we offer in University Heights
          </h2>
        </div>
      ...
      <div class="bs-reveal-up overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="border-b border-[var(--bs-border)] bg-[linear-gradient(180deg,#ffffff_0%,#f3f7fa_100%)] px-6 py-6 md:px-8">
          ...
          <h2 class="mt-2 text-3xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)] md:text-4xl">
            Ready to experience the Brilliant Star difference in University Heights?
          </h2>
        </div>
  ...
  <!-- FAQ -->
  <section class="border-y border-[var(--bs-border)] bg-white py-16 lg:py-20">
    <div class="mx-auto max-w-5xl px-4">
      <div class="bs-reveal-up text-center">
        ...
        <h2 class="mt-4 text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
          Helpful answers for University Heights homeowners
        </h2>
      </div>

      <div class="mt-10 space-y-4">
        <?php foreach ($faq_items as $item) : ?>
          <details class="bs-reveal-stagger bs-faq border border-[var(--bs-border)] bg-[var(--bs-surface)] shadow-[var(--bs-shadow-point)]">
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div class="bs-reveal-left">
          ...
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Explore other service areas near University Heights
          </h2>

          <div class="mt-6 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            <p>
              We proudly serve University Heights and surrounding neighborhoods with the same attention to detail, professionalism, and personalized care.
            </p>
            <p>
              Explore nearby location pages to find the service area that fits your home best.
            </p>
          </div>
            ...
            <?php foreach ($nearby_locations as $area) : ?>
              ...
              >
                ...
                <h3 class="mt-3 text-2xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)]">
                  House Cleaning in <?php echo esc_html($area['name']); ?>
                </h3>

                <p class="mt-3 text-sm leading-7 text-[var(--bs-text-soft)]">
                  Explore residential cleaning services available in <?php echo esc_html($area['name']); ?>, San Diego.
                </p>
      ...
      <div class="overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="grid gap-10 px-6 py-10 md:px-10 md:py-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div class="bs-reveal-left">
            ...
            <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
              Need house cleaning services in University Heights?
            </h2>

            <p class="mt-5 max-w-2xl text-base leading-8 text-[var(--bs-text-soft)]">
              We’ve been serving San Diego households for over 15 years with professional, detail-focused cleaning tailored to each home. Request your free quote today.
            </p>
...
<?php
  $schema = [
    ...
    '@graph' => [
      ...
      [
        '@type' => 'Service',
        '@id' => home_url('/locations/university-heights/') . '#location-service',
        'name' => 'House Cleaning Services in University Heights, San Diego',
        'description' => 'Professional residential cleaning services in University Heights, San Diego. Trusted for 15+ years. Deep cleaning, move-out, regular cleaning and more.',
        'provider' => [
          '@type' => 'LocalBusiness',
          '@id' => home_url('/#business')
        ],
        'areaServed' => [
          '@type' => 'Place',
          'name' => 'University Heights, San Diego'
        ],
        'url' => home_url('/locations/university-heights/')
      ]
    ]
  ];
