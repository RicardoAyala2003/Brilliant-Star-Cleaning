<?php
/**
 * Template Name: San Diego Location Template
 *
 * Location page for San Diego
  ...
  <?php
    ...
    $services = [
      [
        ...
        'copy'  => 'Keep your San Diego home consistently clean with recurring service tailored to your household and schedule.',
      ...
      [
        ...
        'copy'  => 'Leave your San Diego home spotless and move-out ready with a thorough, detail-focused cleaning.',
    ...
    $faq_items = [
      [
        'q' => 'Do you offer house cleaning services throughout San Diego?',
        'a' => 'Yes. Brilliant Star Cleaning Services proudly serves households across San Diego with personalized residential cleaning, deep cleaning, move-in and move-out services, post-construction clean-up, and specialty cleaning.'
      ],
      [
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    <div class="absolute inset-0">
      <img
        ...
        alt="House cleaning services in San Diego"
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      <div class="max-w-4xl">
        ...
        <p class="bs-reveal-up mt-6 max-w-2xl text-base leading-8 text-white/82 md:text-lg">
          Looking for a trusted, experienced home cleaning service in San Diego? Brilliant Star Cleaning Services has been serving San Diego households for over 15 years. We’re local, licensed, insured, and genuinely committed to leaving every home we clean in exceptional condition.
        </p>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div class="bs-reveal-left">
          <div class="relative overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
            <img
              ...
              alt="Residential cleaning in San Diego"
        ...
        <div class="bs-reveal-right">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Trusted House Cleaning in San Diego</p>
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Personalized cleaning for San Diego households
          </h2>
          ...
          <div class="mt-7 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            ...
            <p>
              We work with San Diego homeowners, renters, families, and busy households that want dependable cleaning backed by real experience, detail-focused work, and professional standards.
            </p>
            <p>
  ...
  <section id="services" class="relative overflow-hidden border-y border-[var(--bs-border)] bg-white py-16 lg:py-20">
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
        <div class="bs-reveal-left">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Services in San Diego</p>
      ...
      <div class="bs-reveal-up overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="border-b border-[var(--bs-border)] bg-[linear-gradient(180deg,#ffffff_0%,#f3f7fa_100%)] px-6 py-6 md:px-8">
          ...
          <h2 class="mt-2 text-3xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)] md:text-4xl">
            Ready to experience the Brilliant Star difference in San Diego?
          </h2>
        </div>
    ...
    <div class="mx-auto max-w-5xl px-4">
      <div class="bs-reveal-up text-center">
        ...
        <h2 class="mt-4 text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
          Helpful answers for San Diego homeowners
        </h2>
      </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div class="bs-reveal-left">
          ...
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Explore other service areas near San Diego
          </h2>

          <div class="mt-6 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            <p>
              We proudly serve San Diego and surrounding neighborhoods with the same attention to detail, professionalism, and personalized care.
            </p>
            <p>
      ...
      <div class="overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="grid gap-10 px-6 py-10 md:px-10 md:py-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div class="bs-reveal-left">
            ...
            <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
              Need house cleaning services in San Diego?
            </h2>
...
<?php
  $schema = [
    ...
    '@graph' => [
      ...
      [
        '@type' => 'Service',
        '@id' => home_url('/locations/san-diego/') . '#location-service',
        'name' => 'House Cleaning Services in San Diego',
        'description' => 'Professional residential cleaning services in San Diego. Trusted for 15+ years. Deep cleaning, move-out, regular cleaning and more.',
        'provider' => [
          '@type' => 'LocalBusiness',
          '@id' => home_url('/#business')
        ],
        ...
        'url' => home_url('/locations/san-diego/')
      ]
    ]
  ];
