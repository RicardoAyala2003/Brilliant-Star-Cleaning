<?php
/**
 * Template Name: Residential Cleaning Service Template
 *
 * Regular / Residential Cleaning service page
...
<main class="bs-service-page overflow-hidden bg-[var(--bs-bg)] text-[var(--bs-text)]">
  ...
  <?php
    ...
    $included = [
      ...
      'Kitchen: countertops, stovetop, exterior of appliances, sink',
      'Bathrooms: toilet, shower/tub, sink, mirrors, floors',
      'Emptying trash bins',
      'Basic surface organization',
    ];

    // Transparency copy
    $not_included = 'Interior of refrigerator or oven, exterior windows, closets, ceiling fans, laundry, and outdoor patios are not included in standard regular cleaning. These are available as add-ons or covered in our Deep Cleaning service.';
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      ...
      <div class="mt-12 grid gap-4 md:grid-cols-3">
        ...
        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/62">Professional Standards</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Licensed, Insured, and Detail-Focused</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/62">Equipment</p>
      ...
      <div class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        ...
        <div class="bs-reveal-right">
          ...
          <div class="mt-8 flex flex-col gap-4 sm:flex-row">
            <a href="/about-us/" class="bs-btn bs-btn-secondary inline-flex items-center justify-center px-7 py-4 text-sm font-black uppercase tracking-[0.15em] text-white">
              Meet Our Team
            </a>
      ...
      <div class="grid gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
        <div class="bs-reveal-left">
          ...
          <h2 class="mt-4 max-w-[13ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            What’s Included in Every Regular Cleaning
          </h2>
        </div>
    ...
    <div class="mx-auto max-w-5xl px-4">
      <div class="bs-reveal-up overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        ...
        <div class="px-6 py-6 md:px-8 md:py-8">
          <p class="text-base leading-8 text-[var(--bs-text-soft)]">
            <?php echo esc_html($not_included); ?>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="bs-reveal-up text-center">
        ...
        <p class="mx-auto mt-5 max-w-3xl text-base leading-8 text-[var(--bs-text-soft)]">
          If your home needs more than ongoing upkeep, explore our other cleaning services in San Diego.
        </p>
      </div>
      ...
      <div class="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        <a href="/services/deep-cleaning/" class="bs-reveal-stagger bs-related-card">
          ...
          <p class="mt-4 text-base leading-8 text-[var(--bs-text-soft)]">
            A thorough clean that goes beyond the surface. Perfect for a fresh start or a seasonal reset.
          </p>
        </a>
        ...
        <a href="/services/move-in-cleaning/" class="bs-reveal-stagger bs-related-card">
          ...
          <p class="mt-4 text-base leading-8 text-[var(--bs-text-soft)]">
            Start fresh in your new home with a detailed cleaning before the boxes arrive.
          </p>
        </a>
      </div>
            ...
            <?php foreach ($featured_service_areas as $area) : ?>
              ...
              >
                ...
                <p class="mt-3 text-sm leading-7 text-[var(--bs-text-soft)]">
                  Explore cleaning services available in <?php echo esc_html($area['name']); ?>, San Diego.
                </p>
...
<?php
  $schema = [
    ...
    '@graph' => [
      ...
      [
        '@type' => 'Service',
        '@id' => home_url('/services/residential-cleaning/') . '#service',
        'name' => 'Residential Cleaning Services in San Diego',
        'description' => 'Reliable residential cleaning services in San Diego. Weekly or biweekly home cleaning tailored to your schedule.',
        'provider' => [
          '@type' => 'LocalBusiness',
          '@id' => home_url('/#business')
        ],
        ...
        'url' => home_url('/services/residential-cleaning/')
      ]
    ]
  ];
