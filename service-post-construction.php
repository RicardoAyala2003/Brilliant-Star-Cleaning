<?php
/**
 * Template Name: Post-Construction Cleaning Service Template
 *
 * Post-Construction Cleaning service page
...
<main class="bs-service-page overflow-hidden bg-[var(--bs-bg)] text-[var(--bs-text)]">
  ...
  <?php
    // Images
    $hero_image   = 'http://brilliant-star-cleaning.local/wp-content/uploads/2026/04/PostConstructionCleaningService.jpg-scaled.jpeg';
    $detail_image = 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?q=80&w=1200&auto=format&fit=crop';

    // Included focus areas
    $included = [
      'Cleanup after small to mid-size residential renovation projects',
      'Drywall dust removal from surfaces throughout the home',
      'Cleaning paint splatters and construction residue where possible',
      'Detailed wipe-down of surfaces affected by renovation dust and debris',
      'Floors vacuumed and mopped throughout the cleaned areas',
      'A thorough reset from construction-site condition to livable space',
    ];
    ...
    $faq_items = [
      ...
      [
        ...
        'a' => 'We specialize in cleaning after small to mid-size residential renovation projects. From drywall dust on every surface to paint splatters and construction debris, we come equipped and experienced to handle it all.'
      ],
      [
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    <div class="absolute inset-0">
      <img
        ...
        alt="Post-construction cleaning service in a San Diego home"
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      ...
      <div class="mt-12 grid gap-4 md:grid-cols-3">
        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">Best For</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Small to Mid-Size Renovation Projects</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">What We Handle</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Dust, Debris, Residue &amp; Surface Cleanup</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">Outcome</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">From Construction-Site to Livable Space</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div class="bs-reveal-left">
          <div class="relative overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
            <img
              ...
              alt="Detailed post-construction cleaning service in San Diego"
        ...
        <div class="bs-reveal-right">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Detailed, Thorough, Renovation-Ready</p>
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            A complete cleanup after the work is done
          </h2>
          ...
          <div class="mt-7 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            ...
            <p>
              Our goal is simple: get your home from construction-site condition to truly livable, as quickly and thoroughly as possible.
            </p>
          </div>
  ...
  <section id="included" class="relative overflow-hidden border-y border-[var(--bs-border)] bg-white py-16 lg:py-20">
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
        <div class="bs-reveal-left">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">What We Cover</p>
      ...
      <div class="bs-reveal-up overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="px-6 py-6 md:px-8" style="border-bottom:1px solid var(--bs-border); background:var(--bs-card-soft-bg)">
          ...
          <h2 class="mt-2 text-3xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)] md:text-4xl">
            The final step before your home feels complete again
          </h2>
        </div>

        <div class="px-6 py-6 md:px-8 md:py-8">
          <p class="text-base leading-8 text-[var(--bs-text-soft)]">
            Renovation done? We&apos;ll handle the cleanup. Our post-construction cleaning service is designed to remove lingering dust, debris, and residue so your home feels finished, clean, and ready to enjoy.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="bs-reveal-up text-center">
        ...
        <p class="mx-auto mt-5 max-w-3xl text-base leading-8 text-[var(--bs-text-soft)]">
          Whether you need recurring service, a move-related clean, or a deeper reset, we offer personalized service for every home.
        </p>
      </div>
      ...
      <div class="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        ...
        <a href="/services/specialty-services/" class="bs-reveal-stagger bs-related-card">
          <span class="bs-related-card__eyebrow">Specialty Services</span>
          <h3 class="mt-3 text-2xl font-semibold tracking-[-0.03em] text-[var(--bs-primary)]">
            Specialty Cleaning Services in San Diego
          </h3>
          <p class="mt-4 text-base leading-8 text-[var(--bs-text-soft)]">
            Have a unique cleaning situation? We offer specialty services tailored to your specific needs.
          </p>
        </a>
      </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div class="bs-reveal-left">
          ...
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Post-Construction Cleaning Services Across San Diego &amp; Nearby Neighborhoods
          </h2>
            ...
            <?php foreach ($featured_service_areas as $area) : ?>
              ...
              >
                ...
                <h3 class="mt-3 text-2xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)]">
                  Post-Construction Cleaning in <?php echo esc_html($area['name']); ?>
                </h3>

                <p class="mt-3 text-sm leading-7 text-[var(--bs-text-soft)]">
                  Explore post-construction cleaning services available in <?php echo esc_html($area['name']); ?>, San Diego.
                </p>
      ...
      <div class="overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="grid gap-10 px-6 py-10 md:px-10 md:py-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div class="bs-reveal-left">
            ...
            <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
              Renovation done? We’ll handle the cleanup.
            </h2>

            <p class="mt-5 max-w-2xl text-base leading-8 text-[var(--bs-text-soft)]">
              Our post-construction cleaning service is designed to remove the lingering dust, debris, and residue left behind after renovation work so your home feels finished and ready to enjoy.
            </p>
...
<?php
  $schema = [
    ...
    '@graph' => [
      ...
      [
        '@type' => 'Service',
        '@id' => home_url('/services/post-construction-cleaning/') . '#service',
        'name' => 'Post-Construction Cleaning in San Diego',
        'description' => 'Professional post-construction cleaning for San Diego homes after small to mid-size remodels. Detailed, thorough, and ready for move-in.',
        'provider' => [
          '@type' => 'LocalBusiness',
          '@id' => home_url('/#business')
        ],
        ...
        'url' => home_url('/services/post-construction-cleaning/')
      ]
    ]
  ];
