    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      ...
      <div class="mt-12 grid gap-4 md:grid-cols-3">
        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/62">Best For</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Small to Mid-Size Renovation Projects</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/62">What We Handle</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Dust, Debris, Residue & Surface Cleanup</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/62">Outcome</p>
