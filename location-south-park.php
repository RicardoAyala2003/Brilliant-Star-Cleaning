<?php
/**
 * Template Name: South Park Location Template
 *
 * Location page for South Park
...
<main class="bs-service-page overflow-hidden bg-[var(--bs-bg)] text-[var(--bs-text)]">
  ...
  <?php
    // Images
    $hero_image   = 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=1600&auto=format&fit=crop';
    ...
    $services = [
      [
        ...
        'copy'  => 'Keep your South Park home consistently clean with recurring service tailored to your household and schedule.',
      ...
      [
        ...
        'copy'  => 'Leave your South Park home spotless and move-out ready with a thorough, detail-focused cleaning.',
    ...
    $faq_items = [
      [
        'q' => 'Do you offer house cleaning services in South Park?',
        'a' => 'Yes. Brilliant Star Cleaning Services proudly serves households in South Park with personalized residential cleaning, deep cleaning, move-in and move-out services, post-construction clean-up, and specialty cleaning.'
      ],
      [
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    <div class="absolute inset-0">
      <img
        ...
        alt="House cleaning services in South Park San Diego"
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      <div class="max-w-4xl">
        ...
        <h1 class="bs-reveal-up mt-6 max-w-[13ch] text-4xl font-semibold leading-[0.95] tracking-[-0.05em] text-white md:text-6xl xl:text-7xl">
          Professional House Cleaning Services in South Park, San Diego
        </h1>

        <p class="bs-reveal-up mt-6 max-w-2xl text-base leading-8 text-[var(--bs-hero-text-soft)] md:text-lg">
          Looking for a trusted, experienced home cleaning service in South Park? Brilliant Star Cleaning Services has been serving San Diego households — including South Park — for over 15 years. We’re local, licensed, insured, and genuinely committed to leaving every home we clean in exceptional condition.
        </p>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div class="bs-reveal-left">
          <div class="relative overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
            <img
              ...
              alt="Residential cleaning in South Park San Diego"
        ...
        <div class="bs-reveal-right">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Trusted House Cleaning in South Park</p>
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Personalized cleaning for South Park households
          </h2>
          ...
          <div class="mt-7 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            ...
            <p>
              We work with South Park homeowners, renters, families, and busy households that want dependable cleaning backed by real experience, detail-focused work, and professional standards.
            </p>
            <p>
  ...
  <section id="services" class="relative overflow-hidden border-y border-[var(--bs-border)] bg-white py-16 lg:py-20">
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
        <div class="bs-reveal-left">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Services in South Park</p>
          <h2 class="mt-4 max-w-[13ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Services we offer in South Park
          </h2>
        </div>
      ...
      <div class="bs-reveal-up overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="px-6 py-6 md:px-8" style="border-bottom:1px solid var(--bs-border); background:var(--bs-card-soft-bg)">
          ...
          <h2 class="mt-2 text-3xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)] md:text-4xl">
            Ready to experience the Brilliant Star difference in South Park?
          </h2>
        </div>
    ...
    <div class="mx-auto max-w-5xl px-4">
      <div class="bs-reveal-up text-center">
        ...
        <h2 class="mt-4 text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
          Helpful answers for South Park homeowners
        </h2>
      </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div class="bs-reveal-left">
          ...
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Explore other service areas near South Park
          </h2>

          <div class="mt-6 space-y-5 text-base leading-8 text-[var(--bs-text-soft)]">
            <p>
              We proudly serve South Park and surrounding neighborhoods with the same attention to detail, professionalism, and personalized care.
            </p>
            <p>
      ...
      <div class="overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="grid gap-10 px-6 py-10 md:px-10 md:py-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div class="bs-reveal-left">
            ...
            <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
              Need house cleaning services in South Park?
            </h2>
...
<?php
  $schema = [
    ...
    '@graph' => [
      ...
      [
        '@type' => 'Service',
        '@id' => home_url('/locations/south-park/') . '#location-service',
        'name' => 'House Cleaning Services in South Park, San Diego',
        'description' => 'Professional residential cleaning services in South Park, San Diego. Trusted for 15+ years. Deep cleaning, move-out, regular cleaning and more.',
        'provider' => [
          '@type' => 'LocalBusiness',
          '@id' => home_url('/#business')
        ],
        'areaServed' => [
          '@type' => 'Place',
          'name' => 'South Park, San Diego'
        ],
        'url' => home_url('/locations/south-park/')
      ]
    ]
  ];
