<?php
/**
 * Template Name: Move-Out Cleaning Service Template
 *
...
<main class="bs-service-page overflow-hidden bg-[var(--bs-bg)] text-[var(--bs-text)]">
  ...
  <?php
    // Images
    $hero_image   = 'http://brilliant-star-cleaning.local/wp-content/uploads/2026/04/MoveOutCleaning.jpg-scaled.jpeg';
    $detail_image = 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?q=80&w=1200&auto=format&fit=crop';

    // Included items
    $included = [
      'Bathrooms: mold removal, hard water and limescale treatment, full disinfection of all surfaces',
      'Kitchen: inside and outside of all cabinets and drawers, interior of oven and refrigerator, stainless steel polished to perfection',
      'All floors: vacuumed and mopped throughout',
      'Baseboards, door handles, light fixtures, and vents',
      'Ceiling fans, corners, cobwebs, and visible stains',
      'General dusting and surface wipe-down throughout',
    ];

    // Important notice
    $important_notice = 'For move-out cleanings, the property must be vacant when our team arrives. All drawers and cabinets should be empty. We do not steam-clean or wash carpets, but we thoroughly vacuum and address surface-level carpet concerns where possible.';
  ...
  <section class="relative isolate overflow-hidden border-b border-[var(--bs-border)] bg-[var(--bs-primary)] text-white">
    <div class="absolute inset-0">
      <img
        ...
        alt="Move-out cleaning service in a San Diego home"
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 py-16 lg:py-24">
      ...
      <div class="mt-12 grid gap-4 md:grid-cols-3">
        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">Goal</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Leave It Spotless</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">Coverage</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">Cabinets, Appliances, Baseboards &amp; More</p>
        </div>

        <div class="bs-reveal-stagger bs-hero-strip-card">
          <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--bs-hero-strip-label)]">Built For</p>
          <p class="mt-2 text-lg font-extrabold tracking-[-0.03em] text-white">A Confident Handover on Move-Out Day</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div class="bs-reveal-left">
          <div class="relative overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
            <img
              ...
              alt="Detailed move-out cleaning service in San Diego"
        ...
        <div class="bs-reveal-right">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-[var(--bs-accent)]">Thorough, Efficient, Move-Out Ready</p>
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            A detailed clean designed for the final walkthrough
          </h2>
          ...
          <div class="mt-8 flex flex-col gap-4 sm:flex-row">
            <a href="/contact-us/" class="bs-btn bs-btn-secondary inline-flex items-center justify-center px-7 py-4 text-sm font-black uppercase tracking-[0.15em] text-white">
              Request a Move-Out Cleaning Quote
            </a>
      ...
      <div class="bs-reveal-up overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="px-6 py-6 md:px-8" style="border-bottom:1px solid var(--bs-border); background:var(--bs-card-soft-bg)">
          ...
          <h2 class="mt-2 text-3xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)] md:text-4xl">
            Please have the home vacant and ready before we arrive
          </h2>
        </div>

        <div class="px-6 py-6 md:px-8 md:py-8">
          <p class="text-base leading-8 text-[var(--bs-text-soft)]">
            <?php echo esc_html($important_notice); ?>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="bs-reveal-up text-center">
        ...
        <p class="mx-auto mt-5 max-w-3xl text-base leading-8 text-[var(--bs-text-soft)]">
          From recurring cleaning to move-in preparation and deeper seasonal resets, we offer personalized service for every home.
        </p>
      </div>
    ...
    <div class="relative mx-auto max-w-7xl px-4">
      <div class="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <div class="bs-reveal-left">
          ...
          <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
            Move-Out Cleaning Services Across San Diego &amp; Nearby Neighborhoods
          </h2>
            ...
            <?php foreach ($featured_service_areas as $area) : ?>
              ...
              >
                ...
                <h3 class="mt-3 text-2xl font-semibold leading-tight tracking-[-0.03em] text-[var(--bs-primary)]">
                  Move-Out Cleaning in <?php echo esc_html($area['name']); ?>
                </h3>

                <p class="mt-3 text-sm leading-7 text-[var(--bs-text-soft)]">
                  Explore move-out cleaning services available in <?php echo esc_html($area['name']); ?>, San Diego.
                </p>
      ...
      <div class="overflow-hidden border border-[var(--bs-border)] bg-white shadow-[var(--bs-shadow-card)]">
        <div class="grid gap-10 px-6 py-10 md:px-10 md:py-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div class="bs-reveal-left">
            ...
            <h2 class="mt-4 max-w-[14ch] text-3xl font-semibold leading-tight tracking-[-0.04em] text-[var(--bs-primary)] md:text-5xl">
              Ready to hand over the keys with confidence?
            </h2>
...
<?php
  $schema = [
    ...
    '@graph' => [
      ...
      [
        '@type' => 'Service',
        '@id' => home_url('/services/move-out-cleaning/') . '#service',
        'name' => 'Move-Out Cleaning Services in San Diego',
        'description' => 'Professional move-out cleaning in San Diego. We tackle hard water, mold, appliances, cabinets and every corner so you leave your home spotless.',
        'provider' => [
          '@type' => 'LocalBusiness',
          '@id' => home_url('/#business')
        ],
        ...
        'url' => home_url('/services/move-out-cleaning/')
      ]
    ]
  ];
